...
public final class SupportedOptions {
   ...
   public static Set<String> getAllOptions() {
      Builder<String> a = ImmutableSet.builder();
      a.add(new String[]{"tokens", "outRefMapFile", "disableTargetValidator", "disableTargetExport", "disableOverwriteChecker", "overwriteErrorLevel", "defaultObfuscationEnv", "dependencyTargetsFile"});
      a.addAll(ObfuscationServices.getInstance().getSupportedOptions());
      return a.build();
   }
}
